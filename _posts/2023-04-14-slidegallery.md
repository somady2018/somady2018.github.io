...
이 과정에서 너무나 좋은 선생님들을 만났기에 소개해보는 나의 Best 3 슨생님들!  <br>
...
솔직히 챗GPT 소소하게 써본 사람들이라면 동의할 것 같은데... 
챗GPT의 프롬프트를 제대로 써본 경험부족 때문일까? 생각보다 맘에 드는 답변을 받아내는 것이 사실 쉽지 않다. 
...
사실 아직 실제 결제까지는 이뤄지지 않아서, 나중에 사용량이 증가되면 이 부분도 포스팅 해볼 예정이다. 
